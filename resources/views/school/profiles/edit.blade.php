    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12 clear-padding-xs">
                <h5 class="page-title"><i class="fa fa-cogs"></i>Profile Section</h5>
            ...
            <div class="col-lg-12 clear-padding-xs">
                <div class="col-sm-4">
                    <div class="dash-item first-dash-item">
                        <h6 class="item-title"><i class="fa fa-plus-circle"></i>Your Profile Details</h6>
                        <div class="inner-item">
                            <div class="dash-form">
                                <form action="/school/profiles/store" method="POST" enctype="multipart/form-data">
                                        @csrf
                                ...
                                <input type="text" name="phone" placeholder="080000000"/>
